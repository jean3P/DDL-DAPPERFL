# src/backbone/resnet_heterofl.py
...
class ResNet_c_HeteroFL(
    nn.Module):  # ResNetchp, Width-varying ResNet designed for CIFAR-10, less parameters with deeper network
    def __init__(self, block, num_blocks, p_drop, num_classes=10, track=False):
