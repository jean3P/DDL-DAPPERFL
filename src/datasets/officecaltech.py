# src/satasets/officecaltech.py

import torchvision.transforms as transforms
from utils.conf import data_path
from .utils.federated_dataset import FederatedDataset, partition_office_domain_skew_loaders_new
...
class ImageFolder_Custom(DatasetFolder):
    def __init__(self, data_name, root, train=True, transform=None, target_transform=None, subset_train_num=7,
                 subset_capacity=10):
        ...
        if train:
            self.imagefolder_obj = ImageFolder(self.root + '/Office_Caltech_10/' + self.data_name + '/', self.transform,
...
class FedLeaOfficeCaltech(FederatedDataset):
    ...
    def get_backbone(parti_num, names_list):
        nets_dict = {'res10': resnet10, 'resnet10': resnet10, 'resnet12': resnet12,
                     'res18': resnet18, 'resnet18': resnet18, 'resnet34': resnet34,
